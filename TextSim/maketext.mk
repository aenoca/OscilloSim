...
libs:
	cd $(D) && make -f makedisp.mk
	cd $(T) 
	cd $(S) && make -f makesim.mk
	cd $(T) 
	cd $(O) && make -f makeosc.mk
	cd $(T) 
...
clean:
	rm -r *.o *.txt OscilloSimText

cleanlibs:
	cd $(D) && make clean -f makedisp.mk
	cd $(T) 
	cd $(S) && make clean -f makesim.mk
	cd $(T) 
	cd $(O) && make clean -f makeosc.mk
	cd $(T) 
